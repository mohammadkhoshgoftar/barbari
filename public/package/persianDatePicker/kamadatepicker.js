 ...
 * KamaDatepicker
 * Version: 1.4.7
 * Copyright Ā© 2019 Hadi Kefayati | MIT license
...
var kamaDatepicker = function (elementID, opt) {
    ...
    var FA_NUMS = ['Ł ', 'Ł�', 'Ł¢', 'Ł£', 'Ū´', 'Ūµ', 'Ū¶', 'Ł§', 'ŁØ', 'Ł©', 'Ł�Ł ', 'Ł�Ł�', 'Ł�Ł¢', 'Ł�Ł£', 'Ł�Ū´', 'Ł�Ūµ', 'Ł�Ū¶', 'Ł�Ł§', 'Ł�ŁØ', 'Ł�Ł©', 'Ł¢Ł ', 'Ł¢Ł�', 'Ł¢Ł¢', 'Ł¢Ł£', 'Ł¢Ū´', 'Ł¢Ūµ', 'Ł¢Ū¶', 'Ł¢Ł§', 'Ł¢ŁØ', 'Ł¢Ł©', 'Ł£Ł ', 'Ł£Ł�', 'Ł£Ł¢'];
    ...
    if (options.swapNextPrev)
        titleDiv.append("<button id='bd-prev-" + elementID + "' class='bd-prev' type='button' title='Ł…Ų§Ł‡ Ł‚ŲØŁ„Ū' data-toggle='tooltip'><span>Ł‚ŲØŁ„Ū</span></button>");
    else
        titleDiv.append("<button id='bd-next-" + elementID + "' class='bd-next' type='button' title='Ł…Ų§Ł‡ ŲØŲ¹ŲÆŪ' data-toggle='tooltip'><span>ŲØŲ¹ŲÆŪ</span></button>");
    ...
    if (options.gotoToday) {
        calendarDiv.append("<div class='bd-goto-today'>ŲØŲ±Ł ŲØŁ‡ Ų§Ł…Ų±ŁŲ²</div>");
